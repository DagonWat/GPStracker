...
castle_red = pygame.image.load(os.path.join("pics", "castle_red.png"))
castle_blue = pygame.image.load(os.path.join("pics", "castle_blue.png"))
castle_neit = pygame.image.load(os.path.join("pics", "castle_neit.png"))
